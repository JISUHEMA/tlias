...
public class UserServiceImpL implements UserService{
	...
	public void register(User user) {
		...
		if(!ObjectUtils.isEmpty(userDB)) throw new RuntimeException("このユーザー名は既に存在しています!");
	...
	public User login(String username, String password) {
		...
		if(!userDB.getPassword().equals(pwdSecrete)) throw new RuntimeException("パスワードが間違っています!");
